...
public class UpdateBookBuildResponsePayload extends Validatable implements JSONAware {
    ...
    public UpdateBookBuildResponsePayload(JSONObject fromObject) {
    ...
    public void validateEquals(IValidatable obj, boolean validateFieldsThatAreNullOnThis) throws ValidationException {
        UpdateBookBuildResponsePayload response = (UpdateBookBuildResponsePayload) obj;
