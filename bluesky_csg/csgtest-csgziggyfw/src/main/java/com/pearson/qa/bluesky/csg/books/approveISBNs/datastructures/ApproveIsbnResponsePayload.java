...
public class ApproveIsbnResponsePayload extends Validatable implements JSONAware {
    ...
    public ApproveIsbnResponsePayload(JSONObject fromObject) {
    ...
    public void validateEquals(IValidatable obj, boolean validateFieldsThatAreNullOnThis) throws ValidationException {
        ApproveIsbnResponsePayload response = (ApproveIsbnResponsePayload) obj;
    ...
    public void validateState() throws ValidationException {
        ...
        if (StringUtils.isBlank(getResult())) {
            throw new ValidationException("Result must be present in the response");
        }
    }
