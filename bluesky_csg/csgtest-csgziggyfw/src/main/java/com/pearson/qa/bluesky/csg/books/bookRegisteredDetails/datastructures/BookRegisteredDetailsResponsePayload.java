package com.pearson.qa.bluesky.csg.books.bookRegisteredDetails.datastructures;
...
public class BookRegisteredDetailsResponsePayload extends Validatable implements JSONAware {
    ...
    public BookRegisteredDetailsResponsePayload(JSONObject fromObject) {
    ...
    public void validateEquals(IValidatable obj, boolean validateFieldsThatAreNullOnThis) throws ValidationException {
        BookRegisteredDetailsResponsePayload response = (BookRegisteredDetailsResponsePayload) obj;
