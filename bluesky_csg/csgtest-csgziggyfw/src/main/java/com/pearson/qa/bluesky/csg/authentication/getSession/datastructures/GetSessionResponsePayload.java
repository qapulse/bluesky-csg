package com.pearson.qa.bluesky.csg.authentication.getSession.datastructures;
 ...
 */
public class GetSessionResponsePayload extends Validatable implements JSONAware
{
    ...
    public GetSessionResponsePayload(JSONObject fromJson)
    {
    ...
    public void validateEquals(IValidatable obj, boolean validateFieldsThatAreNullOnThis) throws ValidationException {
        ...
        GetSessionResponsePayload response = (GetSessionResponsePayload) obj;
