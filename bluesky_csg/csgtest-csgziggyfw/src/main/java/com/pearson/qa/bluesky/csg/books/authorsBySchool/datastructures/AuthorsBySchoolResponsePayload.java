package com.pearson.qa.bluesky.csg.books.authorsBySchool.datastructures;
 ...
 */
public class AuthorsBySchoolResponsePayload extends Validatable implements JSONAware {
    ...
    public AuthorsBySchoolResponsePayload(JSONObject fromObject) {
    ...
    public void validateEquals(IValidatable obj, boolean validateFieldsThatAreNullOnThis) throws ValidationException {
        AuthorsBySchoolResponsePayload response = (AuthorsBySchoolResponsePayload) obj;
