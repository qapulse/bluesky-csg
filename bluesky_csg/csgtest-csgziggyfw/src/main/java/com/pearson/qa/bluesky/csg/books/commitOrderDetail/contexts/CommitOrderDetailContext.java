package com.pearson.qa.bluesky.csg.books.commitOrderDetail.contexts;
 ...
 */
public class  CommitOrderDetailContext extends HttpContext {
    CommitOrderDetailResponsePayload responsePayload;
    ErrorResponse errorResponsePayload;

    public CommitOrderDetailContext() {
        super();
    ...
    public void setConfiguration(Configuration configuration)
    {
        ...
        if (this.configuration != null){
            String configNameSpace = configuration.getConfigNamespace(CommitOrderDetailContext.class);
    ...
    public CommitOrderDetailResponsePayload getResponsePayload() {
        return responsePayload;
    }

    public void setResponsePayload(CommitOrderDetailResponsePayload responsePayload) {
