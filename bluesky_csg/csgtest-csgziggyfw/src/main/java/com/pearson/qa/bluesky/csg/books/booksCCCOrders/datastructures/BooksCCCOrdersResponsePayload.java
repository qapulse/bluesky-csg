package com.pearson.qa.bluesky.csg.books.booksCCCOrders.datastructures;
...
public class BooksCCCOrdersResponsePayload extends Validatable implements JSONAware {
    ...
    public BooksCCCOrdersResponsePayload(JSONObject fromObject) {
    ...
    public void validateEquals(IValidatable obj, boolean validateFieldsThatAreNullOnThis) throws ValidationException {
        BooksCCCOrdersResponsePayload response = (BooksCCCOrdersResponsePayload) obj;
