package com.pearson.qa.bluesky.csg.collections.collectionChapters.contexts;
...
public class CollectionChapterContext extends HttpContext {
    CollectionChapterResponsePayload responsePayload;
    ErrorResponse errorResponsePayload;

    public CollectionChapterContext() {
        super();
    ...
    public void setConfiguration(Configuration configuration) {
        ...
        if (this.configuration != null) {
            String configNameSpace = configuration.getConfigNamespace(CollectionChapterContext.class);
    ...
    public CollectionChapterResponsePayload getResponsePayload() {
        return responsePayload;
    }

    public void setResponsePayload(CollectionChapterResponsePayload responsePayload) {
