package com.pearson.qa.bluesky.csg.collections.deleteCollectionNote.contexts;
...
public class  DeleteCollectionNoteContext extends HttpContext {
    DeleteCollectionNoteResponsePayload responsePayload;
    ErrorResponse errorResponsePayload;

    public DeleteCollectionNoteContext() {
        super();
    ...
    public void setConfiguration(Configuration configuration)
    {
        ...
        if (this.configuration != null){
            String configNameSpace = configuration.getConfigNamespace(DeleteCollectionNoteContext.class);
    ...
    public DeleteCollectionNoteResponsePayload getResponsePayload() {
        return responsePayload;
    }

    public void setResponsePayload(DeleteCollectionNoteResponsePayload responsePayload) {
