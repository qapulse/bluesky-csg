package com.pearson.qa.bluesky.csg.books.orderDetailStatus.datastructures;
...
public class OrderDetailStatusResponsePayload extends Validatable implements JSONAware {
    ...
    public OrderDetailStatusResponsePayload(JSONObject fromObject) {
    ...
    public void validateEquals(IValidatable obj, boolean validateFieldsThatAreNullOnThis) throws ValidationException {
        OrderDetailStatusResponsePayload response = (OrderDetailStatusResponsePayload) obj;
