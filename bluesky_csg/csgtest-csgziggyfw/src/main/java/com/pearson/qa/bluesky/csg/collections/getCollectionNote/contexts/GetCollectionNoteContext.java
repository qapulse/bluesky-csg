package com.pearson.qa.bluesky.csg.collections.getCollectionNote.contexts;
...
public class  GetCollectionNoteContext extends HttpContext {
    GetCollectionNoteResponsePayload responsePayload;
    ErrorResponse errorResponsePayload;

    public GetCollectionNoteContext() {
        super();
    ...
    public void setConfiguration(Configuration configuration)
    {
        ...
        if (this.configuration != null){
            String configNameSpace = configuration.getConfigNamespace(GetCollectionNoteContext.class);
    ...
    public GetCollectionNoteResponsePayload getResponsePayload() {
        return responsePayload;
    }

    public void setResponsePayload(GetCollectionNoteResponsePayload responsePayload) {
