package com.pearson.qa.bluesky.csg.taxonomies.getCollectionByISBN.contexts;
...
public class  GetCollectionByISBNContext extends HttpContext {
    GetCollectionByISBNResponsePayload responsePayload;
    ErrorResponse errorResponsePayload;

    public GetCollectionByISBNContext() {
        super();
    ...
    public void setConfiguration(Configuration configuration)
    {
        ...
        if (this.configuration != null){
            String configNameSpace = configuration.getConfigNamespace(GetCollectionByISBNContext.class);
    ...
    public GetCollectionByISBNResponsePayload getResponsePayload() {
        return responsePayload;
    }

    public void setResponsePayload(GetCollectionByISBNResponsePayload responsePayload) {
