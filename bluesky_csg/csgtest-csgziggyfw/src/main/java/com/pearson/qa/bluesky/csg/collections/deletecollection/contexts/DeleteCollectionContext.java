package com.pearson.qa.bluesky.csg.collections.deletecollection.contexts;
...
public class  DeleteCollectionContext extends HttpContext {

    ErrorResponse errorResponsePayload;

    public DeleteCollectionContext() {
        super();
    ...
    public void setConfiguration(Configuration configuration)
    {
        ...
        if (this.configuration != null){
            String configNameSpace = configuration.getConfigNamespace(DeleteCollectionContext.class);
