package com.pearson.qa.bluesky.csg.collections.deletecollection.executors;
...
@Singleton
public class DeleteCollectionExecutor<T extends DeleteCollectionContext> implements Executor<T> {
    private List<Validator<T>> validators;
    private HttpExecutor<T> httpExecutor;

    public DeleteCollectionExecutor() {
        validators = new ArrayList<>();
    }

    public DeleteCollectionExecutor(List<Validator<T>> validators, HttpExecutor<T> httpExecutor) {
    ...
    @Inject
    public void setValidators(List<Validator<DeleteCollectionContext>> validators) {
        if (validators != null) {
            this.validators.clear();
            for (Validator<DeleteCollectionContext> validator : validators)
