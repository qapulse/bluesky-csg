package com.pearson.qa.bluesky.csg.books.authorsBySchool.contexts;
 ...
 */
public class  AuthorsBySchoolContext extends HttpContext {
    AuthorsBySchoolResponsePayload responsePayload;
    ErrorResponse errorResponsePayload;

    public AuthorsBySchoolContext() {
        super();
    ...
    public void setConfiguration(Configuration configuration)
    {
        ...
        if (this.configuration != null){
            String configNameSpace = configuration.getConfigNamespace(AuthorsBySchoolContext.class);
    ...
    public AuthorsBySchoolResponsePayload getResponsePayload() {
        return responsePayload;
    }

    public void setResponsePayload(AuthorsBySchoolResponsePayload responsePayload) {
