package com.pearson.qa.bluesky.csg.books.isbnByNumberOrStatus.contexts;
 ...
 */
public class  IsbnByNumberOrStatusContext extends HttpContext {
    IsbnByNumberOrStatusResponsePayload responsePayload;
    ErrorResponse errorResponsePayload;

    public IsbnByNumberOrStatusContext() {
        super();
    ...
    public void setConfiguration(Configuration configuration)
    {
        ...
        if (this.configuration != null){
            String configNameSpace = configuration.getConfigNamespace(IsbnByNumberOrStatusContext.class);
    ...
    public IsbnByNumberOrStatusResponsePayload getResponsePayload() {
        return responsePayload;
    }

    public void setResponsePayload(IsbnByNumberOrStatusResponsePayload responsePayload) {
